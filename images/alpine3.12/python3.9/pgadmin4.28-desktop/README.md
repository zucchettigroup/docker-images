...
```bash
$ docker run --rm -p 5050:5050 zucchettigroup/pgadmin4
```
...
$ docker run -d -p 5050:5050 --name pgadmin --network=pg zucchettigroup/pgadmin4
```
...
```bash
$ docker run -d -p 5050:5050 -v /Users/me/pgadmin:/pgadmin zucchettigroup/pgadmin4
```
...
```bash
$ docker run -d -p 5050:5050 --name pgadmin --read-only zucchettigroup/pgadmin4
```
...
https://github.com/zucchettigroup/pgadmin4
